...
class DartsTrainer():
    def __init__(self, cfgs, model, dense_order=None, seed=0):
        ...
        if self.model.non_darts:
            ...
            self.checkpoint_dir = f'darts_{self.model.darts_obj}_inner{self.model.inner_steps}_' + self.checkpoint_dir
            if self.test_result_dir is not None:
                self.test_result_dir = f'darts_{self.model.darts_obj}_inner{self.model.inner_steps}_' + self.test_result_dir
