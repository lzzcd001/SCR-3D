import argparse
import torch
from unsup3d import setup_runtime, DartsCombinedTrainer, DartsCombinedUnsup3D
...
trainer = DartsCombinedTrainer(cfgs, DartsCombinedUnsup3D, seed=args.seed, dense_order=args.dense_order)
